...
tktk Hunter - video here: https://www.dropbox.com/sh/4752ohqwgcxh6wf/AADcdEqIaeI_ZO8fBB_8vtG4a?dl=0&preview=MVI_0082.MP4 - timestamp 26:25-27:51
...
\*\*We’ll describe these algorithm types further on in the lesson.
...
Factorial complexity should be avoided at all costs. Here’s why.
...
|                |      |         | Run Times |             |          |
| -------------- | ---- | ------- | --------- | ----------- | -------- |
| Input Size (n) | O(1) | O(logN) | O(N)      | O(N2)       | O(N!)    |
| 1              | 1    | 1       | 1         | 1           | 1        |
...
tktk Hunter - CARDS - one card for each type, with graph
...
<br>
Correct answer: 2. You're starting at index 1 and going up - at worst case, you might have to look through every item (n items!) to find the value.
</details>
